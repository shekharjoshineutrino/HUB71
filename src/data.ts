...
export const categories: Category[] = [
  { id: 'ai', name: 'AI & Machine Learning', icon: 'ai', desc: 'LLMs, generative AI APIs, and model infra.', g1: '#8b5cf6', g2: '#a78bfa' },
  { id: 'cloud', name: 'Cloud & Infrastructure', icon: 'cloud', desc: 'Compute, storage, hosting, and serverless.', g1: '#0284c7', g2: '#38bdf8' },
  { id: 'dev', name: 'Developer Tools & DevOps', icon: 'dev', desc: 'CI/CD, code collaboration, APIs, and observability.', g1: '#6366f1', g2: '#818cf8' },
  { id: 'marketing', name: 'Marketing & Growth', icon: 'marketing', desc: 'SEO, email automation, ads, and lead gen.', g1: '#ec4899', g2: '#f472b6' },
  { id: 'sales', name: 'Sales & CRM', icon: 'sales', desc: 'Pipeline management, outreach, and closing deals.', g1: '#f59e0b', g2: '#fbbf24' },
  { id: 'finance', name: 'Finance, Banking & Legal', icon: 'finance', desc: 'Corporate cards, ADGM legal, and banking.', g1: '#2563eb', g2: '#60a5fa' },
  { id: 'hr', name: 'HR, Payroll & Hiring', icon: 'hr', desc: 'Global hiring, compliance, and team benefits.', g1: '#0d9488', g2: '#2dd4bf' },
  { id: 'product', name: 'Product, Design & UX', icon: 'product', desc: 'Design systems, wireframing, and analytics.', g1: '#d946ef', g2: '#e879f9' },
  { id: 'ops', name: 'Operations & Workspace', icon: 'ops', desc: 'Docs, databases, team wikis, and task tracking.', g1: '#ea580c', g2: '#fb923c' },
  { id: 'support', name: 'Customer Support & Success', icon: 'support', desc: 'Help desk, live chat, and customer retention.', g1: '#10b981', g2: '#34d399' },
  { id: 'security', name: 'Security & Compliance', icon: 'security', desc: 'SSO, auth, SOC2/ISO compliance, and auditing.', g1: '#e11d48', g2: '#fb7185' },
]
